...
Here's an example on [event logging](https://docs.pierresilva.be/laravel-activitylog/v2/advanced-usage/logging-model-events).
...
return [
     ...
     * It should be implements the pierresilva\Activitylog\Contracts\Activity interface
...
If you discover any security related issues, please email freek@pierresilva.be instead of using the issue tracker.

## Postcardware

You're free to use this package, but if it makes it to your production environment we highly appreciate you sending us a postcard from your hometown, mentioning which of our package(s) you are using.

Our address is: pierresilva, Samberstraat 69D, 2060 Antwerp, Belgium.

We publish all received postcards [on our company website](https://pierresilva.be/en/opensource/postcards).
...
Does your business depend on our contributions? Reach out and support us on [Patreon](https://www.patreon.com/pierresilva). 
