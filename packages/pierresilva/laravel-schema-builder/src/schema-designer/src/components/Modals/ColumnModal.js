...
class ColumnModal extends Component<Props, State> {
    ...
    getFormData = () => {
        const data = {
            ...
            validation: this.validation.value.trim(),
                ...
                <Modal.Body>
                    ...
                    >
                        ...
                        <div className='form-group'>
                            <label className='col-xs-3 control-label' htmlFor='label'>Label:</label>
                            <div className='col-xs-9'>
                                <input
                                    type='text'
                                    id='label'
                        ...
                        <div className='form-group'>
                            <label className='col-xs-3 control-label' htmlFor='validation'>Validation:</label>
                            <div className='col-xs-9'>
                                <input
                                    type='text'
                                    id='validation'
                                    ...
                                    className='form-control'
                                    defaultValue={ editData.validation }
                                />
                            </div>
                        </div>
                        <div className='form-group'>
