...
class TableModal extends Component<Props, State> {
    ...
    handleSubmit = (event: Event) => {
        ...
        const data = {
            ...
            logActivities: this.logActivities.checked,
                ...
                <Modal.Body>
                    <form className='form-horizontal' onSubmit={ this.handleSubmit }>
                        ...
                        <div className='form-group'>
                            <label className='col-xs-2 control-label' htmlFor='comment'>Comment:</label>
                            <div className='col-xs-10'>
                                <input
                                    type='text'
                                    id='comment'
                        ...
                        <div className='checkbox'>
                            <label htmlFor='logActivities'>
                                <input
                                    ...
                                    defaultChecked={ editData.logActivities }
                                /> Log Activities
                            </label>
                        </div>
                        <div className='checkbox'>
