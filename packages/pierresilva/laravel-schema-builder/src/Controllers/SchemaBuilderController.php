...
namespace pierresilva\SchemaBuilder\Controllers;

use pierresilva\SchemaBuilder\Migrations\MigrationCreator;
use Exception;
...
class SchemaBuilderController extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('schema-builder::index')->with(compact('css', 'js', 'csrfToken'));
    }
