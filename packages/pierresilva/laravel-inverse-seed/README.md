...
1) Add `pierresilva/laravel-inverse-seed` to your composer file.

#### Laravel 5
For Laravel 5 installation edit your project's `composer.json` file to require `pierresilva/iseed`.

    "require": {
		"pierresilva/laravel-inverse-seed": "master"
	}
