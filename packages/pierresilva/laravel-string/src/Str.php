...
namespace pierresilva\String;

use ArrayAccess;
use pierresilva\String\Integrations\Underscore;
use pierresilva\String\Exceptions\UnsetOffsetException;
use pierresilva\String\Exceptions\UnknownFunctionException;
use pierresilva\String\Exceptions\ErrorCreatingStringException;
 ...
 *
 * @method \pierresilva\String\Str accord($count, $many, $one, $zero = null)
 * @method \pierresilva\String\Str random($length = 16)
 * @method \pierresilva\String\Str quickRandom($length = 16)
 ...
 * @method \pierresilva\String\Str sliceFrom($slice)
 * @method \pierresilva\String\Str sliceTo($slice)
 * @method \pierresilva\String\Str baseClass()
 * @method \pierresilva\String\Str prepend($with)
 * @method \pierresilva\String\Str append($with)
 * @method \pierresilva\String\Str limit($limit = 100, $end = '...')
 * @method \pierresilva\String\Str remove($remove)
 * @method \pierresilva\String\Str replace($replace, $with)
 * @method \pierresilva\String\Str toggle($first, $second, $loose = false)
 * @method \pierresilva\String\Str slugify($separator = '-')
 * @method array explode($with, $limit = null)
 * @method \pierresilva\String\Str lower()
 * @method \pierresilva\String\Str plural()
 * @method \pierresilva\String\Str singular()
 * @method \pierresilva\String\Str upper()
 * @method \pierresilva\String\Str title()
 * @method \pierresilva\String\Str words($words = 100, $end = '...')
 * @method \pierresilva\String\Str toPascalCase()
 * @method \pierresilva\String\Str toSnakeCase()
 * @method \pierresilva\String\Str toCamelCase()
 */
class Str implements ArrayAccess
{
     ...
     *
     * @return mixed|\pierresilva\String\Str
     */
