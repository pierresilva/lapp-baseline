...
namespace pierresilva\OpeningHours;

use DateTime;
use DateTimeZone;
use DateTimeInterface;
use pierresilva\OpeningHours\Helpers\Arr;
use pierresilva\OpeningHours\Exceptions\Exception;
use pierresilva\OpeningHours\Exceptions\InvalidDate;
use pierresilva\OpeningHours\Exceptions\InvalidDayName;

class OpeningHours
{
    /** @var \pierresilva\OpeningHours\Day[] */
