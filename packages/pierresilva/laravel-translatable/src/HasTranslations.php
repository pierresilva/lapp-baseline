...
namespace pierresilva\Translatable;

use Illuminate\Support\Str;
use pierresilva\Translatable\Events\TranslationHasBeenSet;
use pierresilva\Translatable\Exceptions\AttributeIsNotTranslatable;
