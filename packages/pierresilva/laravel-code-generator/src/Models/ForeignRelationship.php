...
class ForeignRelationship implements JsonWriter
{
     ...
     *
     * @return mix (null | pierresilva\CodeGenerator\Models\Resource)
     */
    protected function getForeignResource()
    {
        ...
        if (File::exists(Config::getResourceFilePath($resourceFile))) {
            return Resource::fromFile($resourceFile, 'pierresilva');
        }
     ...
     * @param array $options
     *
     * @return null | pierresilva\CodeGenerator\Model\ForeignRelationship
     */
