...
use pierresilva\CodeGenerator\HtmlGenerators\LaravelCollectiveHtml;
use pierresilva\CodeGenerator\HtmlGenerators\StandardHtml;
use pierresilva\CodeGenerator\Models\Resource;
use pierresilva\CodeGenerator\Models\ViewInput;
use pierresilva\CodeGenerator\Support\Config;
use pierresilva\CodeGenerator\Support\Helpers;
use pierresilva\CodeGenerator\Support\ViewLabelsGenerator;
...
abstract class ViewsCommandBase extends Command
{
     ...
     *
     * @param string $stub
     * @param pierresilva\CodeGenerator\Models\ViewInput $input
     *
     * @return $this
     */
     ...
     * @param string $file
     * @param bool $force
     * @param pierresilva\CodeGenerator\Models\Resource
     *
     * @return bool
     */
     ...
     * @param string $template
     *
     * @return pierresilva\CodeGenerator\HtmlGenerators\HtmlGeneratorBase
     */
