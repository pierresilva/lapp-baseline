...
use pierresilva\CodeGenerator\Support\pierresilvaTranslator;
...
class CreateLanguageCommand extends Command
{
     ...
     *
     * @return pierresilva\CodeGenerator\Support\pierresilvaTranslator | Illuminate\Translation\Translator
     */
    protected function getTranslator()
    {
        if (!Helpers::isNewerThanOrEqualTo()) {
            return pierresilvaTranslator::getTranslator();
        }
     ...
     *
     * @param pierresilva\CodeGenerator\Models\Label
     *
     * @return string
     */
