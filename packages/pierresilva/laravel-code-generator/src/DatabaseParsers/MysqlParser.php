<?php
namespace pierresilva\CodeGenerator\DatabaseParsers;

use App;
use pierresilva\CodeGenerator\DatabaseParsers\ParserBase;
...
use pierresilva\CodeGenerator\Support\FieldTransformer;
...
class MysqlParser extends ParserBase
{
     ...
     *
     * @return array of pierresilva\CodeGenerator\Models\ForeignRelationship;
     */
     ...
     *
     * @return pierresilva\CodeGenerator\Models\ForeignRelationship
     */
     ...
     *
     * @return array of pierresilva\CodeGenerator\Models\Index;
     */
     ...
     * @param object $column
     *
     * @return pierresilva\CodeGenerator\Model\Field;
     */
