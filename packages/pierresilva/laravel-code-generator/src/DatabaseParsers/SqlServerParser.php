<?php
namespace pierresilva\CodeGenerator\DatabaseParser;

use DB;
use App;
use Exception;
use pierresilva\CodeGenerator\Models\Field;
use pierresilva\CodeGenerator\Models\FieldOptimizer;
use pierresilva\CodeGenerator\Support\DatabaseParser\ParserBase;
