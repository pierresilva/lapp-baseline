...
namespace pierresilva\DatabaseModels\Console;

use Illuminate\Console\Command;
use pierresilva\DatabaseModels\Model\Factory;
use Illuminate\Contracts\Config\Repository;

class DatabaseModelsCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'database-models
     ...
     *
     * @param \pierresilva\DatabaseModels\Model\Factory $models
