...
use pierresilva\DatabaseModels\Meta\SchemaManager;
...
class Factory
{
    ...
    /**
     * @var \pierresilva\DatabaseModels\Meta\SchemaManager
     */
    protected $schemas = [];
    ...
    /**
     * @var \pierresilva\DatabaseModels\Support\Classify
     */
    protected $class;

    /**
     * @var \pierresilva\DatabaseModels\Model\Config
     */
    protected $config;

    /**
     * @var \pierresilva\DatabaseModels\Model\ModelManager
     */
    protected $models;

    /**
     * @var \pierresilva\DatabaseModels\Model\Mutator[]
     */
    protected $mutators = [];
     ...
     * @param \pierresilva\DatabaseModels\Support\Classify $writer
     * @param \pierresilva\DatabaseModels\Model\Config $config
     */
    ...
    /**
     * @return \pierresilva\DatabaseModels\Model\Mutator
     */
    ...
    /**
     * @return \pierresilva\DatabaseModels\Model\ModelManager
     */
    ...
    /**
     * @param \pierresilva\DatabaseModels\Model\Model $model
     *
    ...
    /**
     * @param \pierresilva\DatabaseModels\Meta\Blueprint|null $blueprint
     * @param string $key
     * @param mixed $default
     *
     * @return mixed|\pierresilva\DatabaseModels\Model\Config
     */
