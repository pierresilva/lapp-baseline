...
use pierresilva\DatabaseModels\Support\Dumper;
...
class BelongsToMany implements Relation
{
    ...
    /**
     * @var \pierresilva\DatabaseModels\Model\Model
     */
    protected $parent;
     ...
     * @param \pierresilva\DatabaseModels\Model\Model $pivot
     * @param \pierresilva\DatabaseModels\Model\Model $reference
     */
