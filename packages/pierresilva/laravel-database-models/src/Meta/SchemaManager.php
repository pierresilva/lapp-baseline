...
use pierresilva\DatabaseModels\Meta\MySql\Schema as MySqlSchema;
use pierresilva\DatabaseModels\Meta\Sqlite\Schema as SqliteSchema;
...
class SchemaManager implements IteratorAggregate
{
     ...
     * @param string $schema
     *
     * @return \pierresilva\DatabaseModels\Meta\Schema
     */
